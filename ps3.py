...
class RectangularRoom(object):
    ...
    def get_num_cleaned_tiles(self):
        ...
        """
        #raise NotImplementedError
        number_cleaned_tiles = 0
        
        for x in range(self.width):
            for y in range(self.height):
                if self.tile_dirt[(x,y)] == 0:
                    number_cleaned_tiles += 1
        
        return (number_cleaned_tiles)
...
# room.is_tile_cleaned(1, 1)
# room.clean_tile_at_position(pos,0.9)
# room.is_tile_cleaned(1, 1)
# room.get_num_cleaned_tiles()
# pos_not_in_room = Position(3,5)
# room.is_position_in_room(pos_not_in_room)
# room.get_dirt_amount(0,1)
